...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        movie.setScaledSize(QSize(600,334))    #(screen_width,max_gif_size_H))
...
class CustomTopBar(QWidget):
   ...
   def initUI(self):
       ...
       title_label = QLabel(f" {str(Assistantname).capitalize()} V2.0   ")
       title_label.setStyleSheet("color: white; font-size: 15px;; background-color:black")
